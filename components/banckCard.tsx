...
import { obsfucateCardNumber } from "../assets/styles/utils";
        ...
        <View style={styles.center} >
            ...
            >
                <View style={styles.rowFlex}>
                    ...
                    <Image style={{ height: 45, width: 45 }} resizeMode="contain" source={require("../assets/images/logo.png")} />
                </View>

                <View>
                    <View style={[{ marginBottom: 20 }, styles.rowFlex]} >
                        <Image style={styles.cardAsset} resizeMode="contain" source={require("../assets/images/logo.png")} />
